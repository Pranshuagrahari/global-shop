...
const AntiGravityCanvas: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {false && <div className="absolute bottom-4 right-4 pointer-events-none text-xs text-white/20 font-mono text-right">
    ...
    return (
        <nav className="absolute top-0 left-0 w-full z-20 flex justify-between items-center p-6 md:p-8">
            <div className="flex items-center space-x-2">
                ...
                <span className="text-white font-medium tracking-wide text-lg">Global Shop</span>
            </div>
            ...
            <div className="flex items-center gap-4">
                <Link to="/login" className="text-white/80 hover:text-white transition-colors text-sm font-medium">Log in</Link>
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none px-4">
            <div className="max-w-4xl w-full text-center space-y-8">
                ...
                <p className="max-w-2xl mx-auto text-lg md:text-xl text-white/60 font-light leading-relaxed">
                    Register your shop, list unlimited products, and grow your business.
                ...
                <div className="pt-8 pointer-events-auto flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <Link to="/dashboard" className="px-8 py-4 text-white border border-white/20 rounded-full font-medium hover:bg-white/10 transition-colors">
                        View Demo
                    </Link>
                </div>
            </div>
