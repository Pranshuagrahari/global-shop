...
import { signupUser, loginWithGoogle } from '../../../services/firebase/auth.service';
...
const Signup = () => {
    ...
    return (
        <div className="dark relative md:h-screen md:overflow-hidden w-full bg-background text-foreground">
            ...
            <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-4 overflow-y-auto py-8">
